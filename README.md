...
This project is a demo of using **Lynx**, a cross-platform development framework designed to provide a "write once, run anywhere" solution for building user interfaces across multiple platforms.
